...
export function WhatsAppButton({ className }: { className?: string }) {
  ...
  return (
    <a
      ...
      className={`inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#25d366] shadow-[0_4px_14px_rgba(0,0,0,0.3)] transition-transform duration-300 ease-[var(--ease-brand)] hover:scale-110 active:scale-95 ${className ?? ""}`}
    >
