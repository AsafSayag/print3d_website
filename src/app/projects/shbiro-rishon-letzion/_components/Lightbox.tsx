...
/**
 * Full-screen image viewer. Shows the full-resolution image `object-contain`
 * (never cropped), with prev/next controls, keyboard nav (Esc closes, ← / →
 * navigate), backdrop-click to close and a body scroll lock.
 */
