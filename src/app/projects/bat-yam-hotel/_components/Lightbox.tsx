...
/**
 * Full-screen image viewer used by both designs. Shows the full-resolution image
    ...
    >
      ...
      {count > 1 && (
        <>
          ...
          {/* Counter */}
          <span
            className="num absolute bottom-5 left-1/2 -translate-x-1/2 rounded-full border border-white/15 bg-black/40 px-3 py-1 text-sm text-white/90 backdrop-blur"
          >
            {index + 1} / {count}
          </span>
        </>
