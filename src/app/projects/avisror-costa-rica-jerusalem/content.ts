...
export const SPECS: SpecRow[] = [
  ...
  },
  {
    ...
    value:
      "חזיתות אבן ירושלמית בגווני שמנת ובז' עם רשת מרפסות רציפה, מבנה ציבור בחיפוי עץ וטרקוטה עם חזית מזוגגת, קירות תמך מאבן טבעית וטרסות, כבישי אספלט מסומנים ומדרכות משתלבות",
  },
  {
    label: "תאורה",
