...
export const SPECS: SpecRow[] = [
  ...
  },
  {
    ...
    value:
      "חזיתות בגווני לבן ואפור־כחלחל, מרפסות רציפות עם מעקי זכוכית ורצפה בגוון עץ, פרגולות וחדרי מכונות בגגות, זיגוג שקוף וחזיתות לובי מזוגגות, בסיס תצוגה שחור עם מיתוג הפרויקט",
  },
  {
    label: "תאורה",
